...
%token<str> TYPE STATE IDENTIFIER ERROR VOID
...
declaration
   ...
   // | PRECISION precision_qualifier type_specifier //SEMICOLON 
    | TYPE IDENTIFIER '{' struct_declaration_list '}' ';' //LEFT_BRACE RIGHT_BRACE SEMICOLON
    | TYPE IDENTIFIER '{' struct_declaration_list '}' IDENTIFIER ';' //LEFT_BRACE RIGHT_BRACE SEMICOLON
    | TYPE IDENTIFIER '{' struct_declaration_list '}' IDENTIFIER array_specifier ';' // LEFT_BRACE RIGHT_BRACE SEMICOLON
    | TYPE ';' //SEMICOLON
    | TYPE IDENTIFIER ';'  //SEMICOLON
    | TYPE IDENTIFIER identifier_list ';' //SEMICOLON
    | CLASS IDENTIFIER ':' state_list ';'
    ;
...
single_declaration
    ...
    | TYPE IDENTIFIER 
    | TYPE IDENTIFIER array_specifier
    | TYPE IDENTIFIER array_specifier '=' initializer //EQUAL
    | TYPE IDENTIFIER '=' initializer //EQUAL
    ;
