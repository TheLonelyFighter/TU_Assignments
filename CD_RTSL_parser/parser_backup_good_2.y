...
postfix_expression
    ...
    | function_call 
    | postfix_expression STATE ',' STATE
...
declaration
    ...
    | CLASS IDENTIFIER ':' interface_types ';' 
    | TYPE IDENTIFIER ';'
    ;
...
single_declaration
    ...
    | STATE assignment_operator IDENTIFIER
    | TYPE IDENTIFIER '=' STATE
    | TYPE IDENTIFIER '=' IDENTIFIER '(' STATE ')'
    | access_modifiers TYPE IDENTIFIER;
    ;
...
selection_statement
    ...
    | IF '(' expression ')' statement // LEFT_PAREN RIGHT_PAREN
    ;
